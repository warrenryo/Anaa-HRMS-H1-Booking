...
<body>
    ...
    <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="grid lg:grid-cols-2 gap-y-8 lg:gap-y-0 lg:gap-x-6">
            <!-- Content -->
            @if ($user->vip == 'Yes')
                <!-- Features -->
                <div class="max-w-[100rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                    <!-- Grid -->
                    <div class="mt-20 grid gap-6 grid-cols-1 sm:gap-12 lg:grid-cols-1 lg:gap-8">
                        <!-- Stats -->
                        <div>
                            <h4 class="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-200">Loyalty Points
                            </h4>
                            <p class="text-center mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-600">{{$user->points}}</p>
                        </div>
                        <!-- End Stats -->
                ...
                <div class="lg:col-span-2">
                    <div class="py-8 lg:pe-8">
                        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">GET VIP</h2>
                            <p class="mt-1 text-gray-600 dark:text-gray-400">Have access to redeem our loyalty rewards.
                            </p>
                        </div>
                        <!-- End Title -->
                        ...
                        <div class="mt-12">
                            ...
                            <div
                                ...
                                <p class="mb-3"><span
                                        ...
                                        popular</span></p>
                                <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">VIP</h4>
                                <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-gray-200">
                                    <span class="font-bold text-2xl -me-2"><i class="fa-solid fa-peso-sign"></i>
                                    </span>
                                    1,499
                                </span>
                                ...
                                <a class="mt-5 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                    href="{{ url('get-loyalty') }}">
                                    Get VIP Now
                                </a>
                            </div>
                ...
                <div class="sticky top-0 start-0 py-8 lg:ps-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="mt-5 sm:mt-10">
                            <h4 class="text-xs font-semibold uppercase text-gray-800 dark:text-gray-200">RECENT
                                BOOKINGS</h4>
                                ...
                                @foreach ($booking_details as $details)
                                    <li
                                        ...
                                        <div class="flex items-center justify-between w-full">
                                            <span>{{ $details['room_type'] }} - Room {{ $details['room_no'] }}</span>
                                            <span><i class="fa-solid fa-peso-sign"></i> {{ $details['price'] }}</span>
                                            <span>{{ \Carbon\Carbon::parse($details['created_at'])->format('Y-m-d') }}</span>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
