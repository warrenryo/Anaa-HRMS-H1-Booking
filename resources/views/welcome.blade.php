...
.container {
	...
	border-radius: 10px;
  	box-shadow: 0 8px 15px rgb(223, 221, 221), 
			0 10px 10px rgb(198, 195, 195);
	position: relative;
	overflow: hidden;
	width: 900px;
	max-width: 100%;
...
.overlay {
	...
	background: rgb(144,60,0);
background: linear-gradient(157deg, rgba(144,60,0,1) 0%, rgba(255,132,0,1) 40%, rgba(203,145,78,1) 100%);
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="#">
			...
			<span>or use your Gmail Address</span>
	...
	<div class="form-container sign-in-container">
		<form action="{{route('login')}}" method="POST">
			...
			<h1>Sign in</h1>
            <div>
                <img src="{{('img/anaa_logs.png')}}" alt="Placeholder Image" class="mt-4">
         
            </div>

			<span>or Use your Account!</span>
            <div class="p-2 w-[35vh] mt-4">
				<div class="relative">
			...
			<div class="p-2 w-[35vh]">
				<div class="relative">
					<input type="text" name="password" id="floating_outlined" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
