...
<head>
    ...
    <title>Anaa:Hotel and Restaurant</title>
...
<body>
                    ...
                    <div class="grid justify-center md:grid-cols-2 md:justify-between md:items-center gap-2">
                        <div class="text-center md:text-start">
                            ...
                            <p class="mt-1 text-white font-medium">
                                Avail VIP to get Loyalty Awards.
                            </p>
                        </div>
                        <!-- End Col -->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="https://h4-booking.anaa-hrms.com">
                                        Event Reservation
                                    </a>
                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="https://r1-reservation.anaa-hrms.com">
                                        Table Reservation
                                    </a>
                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="#">
    ...
    <section id="home">
        <div
            class="relative bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
            <img class="w-full md:h-[50vh] xl:h-[80vh]  brightness-[25%]" src="{{ asset('img/home/room.jpg') }}"
                alt="Image Description">
            <div class="absolute top-0 start-0 end-0">
                <div class="text-center mt-20 lg:mt-32 xl:mt-[30vh]">
                    <h3 class="hide md:text-[2vh] xl:text-[4vh] font-bold text-white">
                        WELCOME TO:
                    </h3>
                    <p class="hide md:text-[4vh] xl:text-[8vh] mt-1 text-white">
                        ANAA: HOTEL AND RESTAURANT
                    </p>
                    <div class="mt-10">
                        <a href=""
                            class="bg-transparent p-4 px-8 hover:bg-[#9c603b] duration-300 text-sm text-white border border-[#9c603b]">
                            BOOK NOW
                        </a>
                    </div>
    ...
    <section class="p-[10vh]">
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
                <div class="hide_2 lg:col-span-3">
                    <h1 class="block text-5xl font-semibold text-gray-800  dark:text-white mb-6 ">
                        Welcome
                        to our residence</h1>
                    <p class="mt-3 text-md mb-10">
                        Beginning blessed second a creepeth. Darkness wherein fish years good air whose after seed
                        appear midst evenin, appear void give third bearing divide one so blessed moved firmament
                        gathered

                        Beginning blessed second a creepeth. Darkness wherein fish years good air whose after seed
                        appear midst evenin, appear void give third bearing divide one so blessed
                    </p>
                    <a href=""
                        class="bg-[#9c603b] text-white hover:text-black p-4 px-8 mt-2 text-sm hover:bg-transparent border border-[#9c603b] duration-300">LEARN
                        MORE</a>


                    <!-- Brands -->
                    <div class="mt-6 mt-12">
                            ...
                            <svg class="w-20 h-auto" width="106" height="36" viewBox="0 0 106 36"
                                ...
                                <g clip-path="url(#clip0)">
                                    <path
                                        ...
                                        fill="currentColor" class="fill-gray-800 dark:fill-gray-200" />
                                </g>
                                <defs>
                                    <clipPath id="clip0">
                ...
                <div class="hide_3 lg:col-span-4 mt-10 lg:mt-0">
                    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 gap-2">
                        <div class="space-y-2">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/welcomeBanner1.png') }}"
                                alt="Image Description">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/welcomeBanner2.png') }}"
                                alt="Image Description">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/welcomeBanner3.png') }}"
                                alt="Image Description">
                        </div>
                        <div class="hidden lg:block space-y-2">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/explore1.png') }}"
                                alt="Image Description">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/explore2.png') }}"
                                alt="Image Description">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/explore3.png') }}"
                                alt="Image Description">
                        </div>
                        <div class=" space-y-2">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/explore4.png') }}"
                                alt="Image Description">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/explore5.png') }}"
                                alt="Image Description">
                            <img class="w-full h-auto object-cover" src="{{ asset('img/home/explore6.png') }}"
                                alt="Image Description">
                        </div>
                    </div>
                </div>
    ...
    <section class="py-10 lg:p-[10vh]" id="rooms">
        <div class="hide max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8 ">
            <div class="flex flex-col justify-center mt-20">
                <div class="flex flex-col items-center justify-center">
                    <img src="{{ asset('img/home/cutlogo.png') }}" alt="" style="width: 84px;">
                    <h1 class="text-4xl mt-2">Rooms Available</h1>
                </div>

                <div class="place-items-center grid lg:grid-cols-2 xl:grid-cols-3 gap-4 mt-20 ">
                    @forelse ($rooms as $room)
                        <div
                            class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="{{ url('booknowIndex/' . $room->id) }}">
                                <img class="rounded-t-lg" src="{{ asset($room->roomImages[0]->images) }}"
                                    alt="" />
                            </a>
                            <div class="p-5">
                                <h1 class="text-3xl">
                                    ₱ {{ number_format($room->roomPrice->three_hours) }}
                                </h1>
                                <a href="#">
                                ...
                                <a href="{{ url('booknowIndex/' . $room->id) }}"
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black hover:text-white bg-transparent duration-300 hover:bg-[#9c603b] rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Book Now
        ...
        <div class="flex items-center justify-center mt-4">
            <a href="{{ url('view-all-rooms') }}"
                class="bg-[#9c603b] text-white hover:text-black p-4 px-8 mt-2 text-sm hover:bg-transparent border border-[#9c603b] duration-300">VIEW
                ALL ROOMS</a>
        </div>
    </section>
    ...
    <section class="bg-gray-100">
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Title -->
            <div class="hide_2 flex flex-col items-center justify-center mb-10">
                <img src="{{ asset('img/home/cutlogo.png') }}" alt="" width="84px">
                <h1 class="text-4xl mt-2">Special Facilities</h1>
            </div>
            <!-- End Title -->

            <!-- Grid -->
            <div class="hide_3 grid sm:grid-cols-4 lg:grid-cols-4 gap6">
                <!-- Card -->
                <a class="group hover:bg-gray-100 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]"
                    href="#">
                    <div class="aspect-w-16 aspect-h-10">
                        <img class="w-full object-cover rounded-xl" src="{{ asset('img/home/spa.jpg') }}"
                            alt="Image Description">
                    </div>
                ...
                <a class="group hover:bg-gray-100 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]"
                    href="#">
                    <div class="aspect-w-16 aspect-h-10">
                        <img class="w-full object-cover rounded-xl" src="{{ 'img/home/swim.jpg' }}"
                            alt="Image Description">
                    </div>
                    <h3 class="mt-5 text-xl text-gray-800 dark:text-gray-300 dark:hover:text-white">
                        Swimming Pools
                ...
                <a class="group hover:bg-gray-100 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]"
                    ...
                    <div class="aspect-w-16 aspect-h-10">
                        <img class="w-full object-cover rounded-xl"
                            src="{{ 'img/home/res.jpg' }}"alt="Image Description">
                    </div>
                ...
                <a class="group hover:bg-gray-100 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]"
                    ...
                    <div class="aspect-w-16 aspect-h-10">
                        <img class="w-full object-cover rounded-xl"
                            src="{{ 'img/home/event.jpg' }}"alt="Image Description">
                    </div>
    ...
    <section>
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Title -->
            <div class="hide max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Hot Deals</h2>
                <p class="mt-1 text-gray-600 dark:text-gray-400">Check some of the amazing deals for the Month of
                    April.
                </p>
            </div>
            <!-- End Title -->
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Card -->
                <a class="con1 hide group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg transition-all duration-300 rounded-xl p-5 dark:border-gray-700 dark:hover:border-transparent dark:hover:shadow-black/[.4] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="#">
                    <div class="aspect-w-16 aspect-h-11">
                        <img class="w-full object-cover rounded-xl"
                            src="{{ 'img/home/summer deals.gif' }}"alt="Image Description">
                    </div>
                    <div class="my-6">
                        ...
                        <p class="mt-5 text-gray-600 dark:text-gray-400">
                            Book a room for affordable prize!
                        </p>
                    </div>
                ...
                <a class="con1 hide group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg transition-all duration-300 rounded-xl p-5 dark:border-gray-700 dark:hover:border-transparent dark:hover:shadow-black/[.4] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="#">
                    <div class="aspect-w-16 aspect-h-11">
                        <img class="w-full object-cover rounded-xl" src="{{ 'img/home/food deals.jpg' }}"
                            alt="Image Description">
                    </div>
                    <div class="my-6">
                        <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-300 dark:group-hover:text-white">
                        ...
                        <p class="mt-5 text-gray-600 dark:text-gray-400">
                            Come and avail our Kore-amazing menu!
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1  gap-6 lg:gap-8">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200">VIP Perks</h3>
                                <div class="text-sm text-gray-500">Unlock & Enjoy our Perks</div>
                                <span
                                    class="absolute top-0 end-0 rounded-se-xl rounded-es-xl text-xs font-medium bg-gray-800 text-white py-1.5 px-3 dark:bg-white dark:text-gray-800">Most
                                    popular</span>

                                <div class="mt-5">
                                    <span class="text-6xl font-bold text-gray-800 dark:text-gray-200">₱1,499</span>
                                    <span class="text-lg font-bold text-gray-800 dark:text-gray-200">.99</span>
                                    <span class="ms-3 text-gray-500">PHP /3 months validity</span>
                                </div>
                                ...
                                <div
                                    ...
                                    <ul class="space-y-2 text-sm sm:text-base">
                                        ...
                                        <li class="flex space-x-3">
                                            ...
                                            <span class="text-gray-800 dark:text-gray-200">
                                                Free Access in VIP Area (Resto-Bar)
                                            </span>
                                        </li>
                                    </ul>
                                    <!-- End List -->
                                ...
                                <div class="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Use cards for conveniency.</p>
                                    </div>

                                    <div class="flex justify-end">
                                        <button type="button"
                                            class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#9c603b] text-white hover:bg-[#9c603b] disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                            Avail VIP Plan</button>
                                    </div>
                                </div>
            ...
            <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    <div class="col-span-full lg:col-span-1">
                        <a class="flex-none text-xl font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="#" aria-label="Brand">Anaa Hotel & Restaurant
                            Restaurant</a>
                    </div>
                    <!-- End Col -->
                ...
                <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
                    <div class="flex justify-between items-center">
                        <p class="text-sm text-gray-400">© 2024 Anaa Hotel & Restaurant. All rights reserved.</p>
                    </div>
                    <!-- End Col -->
